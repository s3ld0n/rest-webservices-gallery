package com.artisan.solutions.gallery.spring;
...
@ComponentScan({ "com.artisan.solutions.gallery" })
@PropertySource({ "classpath:application.properties" })
@EnableJpaRepositories(basePackages = "com.artisan.solutions.gallery.persistence.repo")
public class PersistenceJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.artisan.solutions.gallery" });
